...
This file contains the data from the course "Experimental Advanced Biochemistry I" (Biochemistry Degree, [Universidad Autónoma de Madrid](https://www.uam.es)). Surveys were filled by students in the years 2017-2022 directly on Moodle the last day of each course. This is a preliminary summary of the data analysis. The GitHub [repo](https://github.com/mredrejo/bqexav) contains the original files from all the analyses.
